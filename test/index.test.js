...
describe('test fizzBuzz game', () => {
    ...
    test('当输入的是3的倍数，应当返回Fizz', () => {
        const result = fizzBuzz(6)
        expect(result).toBe('Fizz')
    })

    test('当输入的是5的倍数，应当返回Buzz', () => {
        const result = fizzBuzz(10)
        expect(result).toBe('Buzz')
    })

    test('当输入的是7的倍数，应当返回Whizz', () => {
        const result = fizzBuzz(14)
        expect(result).toBe('Whizz')
    })

    test('当输入的是3和5的倍数，应当返回FizzBuzz', () => {
        const result = fizzBuzz(15)
        expect(result).toBe('FizzBuzz')
    })
    test('当输入的是3和7的倍数，应当返回FizzWhizz', () => {
        const result = fizzBuzz(21)
        expect(result).toBe('FizzWhizz')
    })
    test('当输入的是5和7的倍数，应当返回BuzzWhizz', () => {
        const result = fizzBuzz(70)
        expect(result).toBe('BuzzWhizz')
    })
    test('当输入的是3和5和7的倍数，应当返回FizzBuzzWhizz', () => {
